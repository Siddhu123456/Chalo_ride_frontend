...
const DriverTripHistory = () => {
  ...
  const { tripHistory, loading, error } = useSelector((state) => state.driver);
    ...
    <div className="trip-history-container">
      ...
      <div className="trips-list">
        {loading ? (
          ...
          <div className="no-trips"><p>No trips found</p></div>
        ) : (
                ...
                <div className="detail-item">
                  ...
                  <div className="detail-text">
                    ...
                    <span className="detail-value">
                      {formatDate(trip.completed_at)} • {formatTime(trip.completed_at)}
                    </span>
                  </div>
                </div>
